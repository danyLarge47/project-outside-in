...
namespace GameCreator.Runtime.Common
{
    ...
    public class GetGameObjectFindComponentInChildren : PropertyTypeGetGameObject
    {
        ...
        [SerializeField] private PropertyGetBool m_IncludeInactive = new PropertyGetBool(false);
        ...
        public override GameObject Get(Args args)
        {
            ...
            bool includeInactive = this.m_IncludeInactive.Get(args);

            if (from == null)
            {
                UnityEngine.Object instance = UnityEngine.Object.FindAnyObjectByType(
                    type,
            ...
            Component children = from.GetComponentInChildren(type, includeInactive);
