...
namespace GameCreator.Runtime.Common
{
    ...
    public abstract class TRunner<TValue> : Runner
    {
            ...
            where TRunnerType : TRunner<TValue>
        {
            ...
            EntityId containerId = container.GetEntityId();
            container.name = containerId.ToString();
            ...
            where TRunnerType : TRunner<TValue>
        {
            ...
            EntityId templateHash = template.GetEntityId();
        ...
        public static void Restore(Runner runner)
        {
            ...
            if (Pool.TryGetValue(runner.Template.GetEntityId(), out RunnerPool runnerPool))
            {
