...
namespace GameCreator.Runtime.Common
{
    public static class CacheUtils
    {
        ...
        private static readonly Dictionary<EntityId, Cache> CACHE = new Dictionary<EntityId, Cache>();
        ...
        {
            List<EntityId> removeKeys = new List<EntityId>();
            
            foreach (KeyValuePair<EntityId,Cache> entry in CACHE)
            {
            ...
            foreach (EntityId removeKey in removeKeys)
            {
