...
namespace GameCreator.Runtime.Common
{
    internal class PoolData
    {
        ...
        [NonSerialized] private readonly PoolKey m_CollectionId;
        ...
        [NonSerialized] private readonly Dictionary<EntityId, PoolInstance> m_RunningInstances;
        ...
        {
            this.m_CollectionId = PoolKey.FromPrefab(prefab);
            ...
            this.m_RunningInstances = new Dictionary<EntityId, PoolInstance>();
        ...
        {
            this.m_CollectionId = PoolKey.FromCollection(collectionId);
            this.m_Prefab = null;
        ...
        public void Prewarm(PoolKey collectionId, int count)
        {
