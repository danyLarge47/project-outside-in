...
namespace GameCreator.Runtime.Cameras
{
    ...
    public class ShotSystemThirdPerson : TShotSystem
    {
        ...
        public void Aim(float shoulder, float lift, float radius, Vector3 focus, float duration)
        {
            ...
            Vector3 aimFromPosition = this.PivotPosition +
                Vector3.up * (lift - this.m_Aim.Lift) +
                currentHAxis * shoulder;

            Vector3 nextDirection = (focus - aimFromPosition).normalized;
        ...
        private void UpdateOrbit(TShotType shotType)
        {
            ...
            shotType.Position = this.PivotPosition - direction * this.Radius + horizontalAxis * this.m_Aim.Shoulder;
        }
        ...
        private bool CalculatePositions()
        {
            ...
            this.PivotPosition = this.Pivot.transform.position + Vector3.up * this.m_Aim.Lift;
            return true;
        }
