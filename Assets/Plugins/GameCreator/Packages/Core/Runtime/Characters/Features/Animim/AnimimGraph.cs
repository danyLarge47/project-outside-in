...
namespace GameCreator.Runtime.Characters.Animim
{
    ...
    public class AnimimGraph
    {
        ...
        [NonSerialized] private TimeMode.UpdateMode m_GraphUpdateMode;
        ...
        internal void OnUpdate()
        {
            ...
            if (this.m_Character.Time.UpdateTime == this.m_GraphUpdateMode) return;

            this.ApplyTimeUpdateMode();
        }
        ...
        {
            this.m_GraphUpdateMode = this.m_Character.Time.UpdateTime;

            this.Graph.SetTimeUpdateMode(this.m_GraphUpdateMode switch
            {
