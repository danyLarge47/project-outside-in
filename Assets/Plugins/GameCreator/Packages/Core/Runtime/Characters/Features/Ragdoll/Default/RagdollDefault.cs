...
namespace GameCreator.Runtime.Characters
{
    ...
    public class RagdollDefault : TRagdollSystem
    {
        ...
        [NonSerialized] private EntityId m_CurrentModelID = EntityId.None;
        ...
        private void RequireInitialize(Character character, bool force)
        {
            ...
            EntityId modelID = character.Animim.Animator.gameObject.GetEntityId();
        ...
        {
            this.m_CurrentModelID = EntityId.None;
        }
