...
namespace GameCreator.Runtime.Characters
{
    ...
    public class UnitDriverController : TUnitDriver
    {
        ...
        private const float SLOPE_LENIENCY = 2.5f;
        ...
        protected virtual void UpdateProperties()
        {
            ...
            float steepSlopeAngle = this.m_IsOnSteepSlope
                ? this.m_MaxSlope
                : this.m_MaxSlope + SLOPE_LENIENCY;

            this.m_IsOnSteepSlope = this.IsGrounded && floorAngle > steepSlopeAngle;
