...
namespace GameCreator.Editor.Common
{
    public abstract class PropertyEditor : PropertyDrawer
    {
        ...
        {
            private readonly EntityId instanceId;
            ...
            {
                this.instanceId = property.serializedObject.targetObject.GetEntityId();
                this.propertyPath = property.propertyPath;
            }

            public PropertyKey(EntityId instanceId, string propertyPath)
            {
